...
exports.run = async(bot, message, args, queue) => {
  ...
  const serverQueue = queue.get(message.guild.id);
      ...
      if (message.member.voiceChannelID !== "304339570047188992" && !message.member.voiceChannelID) return message.channel.send(":musical_note: :x:***__You Must be in the music room to use this Command!__*** :x: :musical_note:")
